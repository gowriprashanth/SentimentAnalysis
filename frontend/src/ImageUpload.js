...
const ImageUpload = () => {
  ...
  const onFileUpload = () => {
    ...
    reader.onloadend = function () {
      ...
      axios
        .post("https://u0e8x85ktk.execute-api.us-east-1.amazonaws.com/prod/upload-image", { body: base64String })
        .then(response => {
  ...
  const onTextUpload = () => {
    axios
      .post("https://u0e8x85ktk.execute-api.us-east-1.amazonaws.com/prod/upload-text", { body: textInput })
      .then(response => {
